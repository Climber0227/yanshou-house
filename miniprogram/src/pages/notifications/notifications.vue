...
.notif-item { display: flex; align-items: flex-start; gap: 8px; padding: 14px 0; border-bottom: 1px solid #F1F5F9; }
.notif-item.unread { background: #F8FAFC; margin: 0 -16px; padding: 14px 16px; }
